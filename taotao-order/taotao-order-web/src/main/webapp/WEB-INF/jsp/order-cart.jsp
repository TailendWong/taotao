...
<form id="orderForm" class="hide" action="http://taotao.3w.dkys.org/payOrder.html" method="post">
		...
		<c:forEach items="${cartList }" var="cart" varStatus="status">
			...
			<input type="hidden" name="orderItems[${status.index}].title" value="${cart.tbItem.title}"/>
			<input type="hidden" name="orderItems[${status.index}].picPath" value="${cart.tbItem.image}"/>
		</c:forEach>
		...
		<div class="goods-item goods-item-extra">
			...
			<div class="goods-msg">
				...
				<div class="p-price">
					...
					<!--增加预售金额显示 end-->
					<span class="ml20"> x${cart.tbItem.num} </span> 
